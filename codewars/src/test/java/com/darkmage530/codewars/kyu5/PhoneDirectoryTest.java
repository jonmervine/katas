...
public class PhoneDirectoryTest {
    ...
    private PhoneDirectory phoneDirectory = new PhoneDirectory();

    private final static String dr = "/+1-541-754-3010 156 Alphand_St. <J Steeve>\n 133, Green, Rd. <E Kustur> NY-56423 ;+1-541-914-3010\n"
    ...
    @Test
    public void foundTooManyPeople() {
        testing(PhoneDirectory.phone(dr, "1-098-512-2222"), "Error => Too many people: 1-098-512-2222");
    }

    @Test
    public void findName() {
        testing(phoneDirectory.retrieveName("<Bernard Deltheil> +1-498-512-2222; Mount Av.  Eldorado"), "Bernard Deltheil");
    }

    @Test
    public void findAddress() {
        testing(phoneDirectory.retrieveAddress("<Bernard Deltheil> +1-498-512-2222; Mount Av.  Eldorado"), "Mount Av. Eldorado");
    }
}