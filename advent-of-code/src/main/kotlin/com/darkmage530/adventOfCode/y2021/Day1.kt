...
class Day1 {
    ...
    fun day1() {
        ...
        var totalGreater = 0
        File("advent-of-code/src/main/resources/2021/Day1.txt").forEachLine {
...
//        val depths: List<Int> = input.split("\n").map { Integer.parseInt(it) }
        val depths: List<Int> = File("advent-of-code/src/main/resources/2021/Day1.txt").readLines().map { Integer.parseInt(it) }
        var total = 0
